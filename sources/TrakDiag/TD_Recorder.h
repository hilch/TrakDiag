...
"<head><!-- created with https://github.com/hilch/TrackDiag V " STRINGIFY(_TrakDiag_VERSION) " - TD_Recorder.cpp -->\n"
"\t<title>%s</title>\n"
/* styles */
...
"\n"
"\t\t\txy( segmentPosition ){\n"
"\t\t\t\treturn this.element.getPointAtLength(segmentPosition * this.element.getTotalLength());\n"
"\t\t\t}\n"
"\n"
"\t\t\tpaintShuttle( svg ){\n"
...
"\t\t\t\t\t\t+ 'segment-position: ' + this.segmentPosition;\n"
